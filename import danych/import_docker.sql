...
LOAD DATA INFILE '/import_danych/tbl_konstelacje.csv'
...
LOAD DATA INFILE '/import_danych/tbl_gwiazdy.csv'
...
LOAD DATA INFILE '/import_danych/tbl_statki_kosmiczne.csv'
...
LOAD DATA INFILE '/import_danych/tbl_nawigatorzy.csv'
...
LOAD DATA INFILE '/import_danych/tbl_planety.csv'
...
LOAD DATA INFILE '/import_danych/tbl_obserwatoria.csv'
...
LOAD DATA INFILE '/import_danych/tbl_instrumenty_nawigacyjne.csv'
...
LOAD DATA INFILE '/import_danych/tbl_misje.csv'
...
LOAD DATA INFILE '/import_danych/tbl_trasy_nawigacyjne.csv'
...
LOAD DATA INFILE '/import_danych/tbl_logi_nawigacyjne.csv'
